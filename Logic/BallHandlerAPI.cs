...
namespace Logic
{
    public abstract class BallHandlerAPI
    {
        ...
        public abstract void CheckCollision(BallAPI mainBall);
    ...
    internal class BallHandler : BallHandlerAPI
    {
        ...
        public override void CheckCollision(BallAPI mainBall)
        {
            double distance;

            foreach (BallAPI ball in BallCollection)
            {
                if (ball == mainBall)
                {
                    continue;
                ...
                {
                    double nx = (ball.X - mainBall.X) / distance;
                    double ny = (ball.Y - mainBall.Y) / distance;
